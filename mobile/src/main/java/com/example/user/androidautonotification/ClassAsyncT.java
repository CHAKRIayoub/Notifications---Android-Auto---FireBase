...
public class ClassAsyncT extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            //connexion avec le service web____________________________________

            url = new URL("http://192.168.1.3/notifications/getNotifications.php");
    ...
    protected void onPostExecute(String s) {
        ...
        //récupérer les données JSON et remplire la listview
        myfunction();
    ...
    //la fonction permet de récupérer les données JSON et remplire la listview
